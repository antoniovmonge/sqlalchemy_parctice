...
Revision ID: cec120c6ef33
Revises: f7853acec304
Create Date: 2023-09-19 16:13:58.159897
...
revision: str = "cec120c6ef33"
down_revision: Union[str, None] = "f7853acec304"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["order_id"], ["orders.id"], name=op.f("fk_orders_items_order_id_orders")
        ),
        sa.ForeignKeyConstraint(
            ["product_id"],
            ["products.id"],
